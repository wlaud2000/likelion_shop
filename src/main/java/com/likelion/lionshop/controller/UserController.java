...
public class UserController {
    ...
    @GetMapping(value = "")
    public String getUser(@RequestBody CreateUserRequestDto createUserRequestDto) {
        log.info("ID = {}",createUserRequestDto.getId());
        return "사용자 조회";
    }
    ...
    @DeleteMapping(value = "")
    public String deleteUser(@RequestBody CreateUserRequestDto createUserRequestDto) {
        log.info("ID = {}", createUserRequestDto.getId());
        return "사용자 삭제";
    }
